...
namespace Seo
{
    public class WeatherSky
    {
        ...
        public static string ColorDirectory
        {
            get
            {
                if (colorDirectory == null)
                {
                    ...
                    {
                        throw new Seo.Exceptions.CannotFindInstallDirException();
                    }
                }
        ...
        public static string GetWeatherName(Weather weather)
        {
            ...
            {
                case Weather.Clear:
                    return Seo.Language.Weather.Clear;
                case Weather.PartlyCloudy:
                    return Seo.Language.Weather.PartlyCloudy;
                case Weather.Overcast:
                    return Seo.Language.Weather.Overcast;
                case Weather.Stormy:
                    return Seo.Language.Weather.Storm;
                case Weather.Custom:
                    return Seo.Language.Weather.Custom;
                default:
                    return null;
            }
        }
